fpath+=( $HOME/.cache/antidote/https-COLON--SLASH--SLASH-github.com-SLASH-givensuman-SLASH-zsh-allclear )
source $HOME/.cache/antidote/https-COLON--SLASH--SLASH-github.com-SLASH-givensuman-SLASH-zsh-allclear/zsh-allclear.plugin.zsh
fpath+=( $HOME/.cache/antidote/https-COLON--SLASH--SLASH-github.com-SLASH-givensuman-SLASH-appa-zsh-theme )
source $HOME/.cache/antidote/https-COLON--SLASH--SLASH-github.com-SLASH-givensuman-SLASH-appa-zsh-theme/appa.zsh-theme
